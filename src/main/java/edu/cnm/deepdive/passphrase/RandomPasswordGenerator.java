...
/**
 * This generates random passwords with user input.
 *
 */

public class RandomPasswordGenerator extends RandomArtifactGenerator {

  /** Gives user options to exclude */
  ...
  public String generate() {
    ...
    /**
     * If order is excluded with user input then checks password characters and numbers
     * for ascending and descending order. (e.g. ABC, CBA)
     */
  ...
  /**
   * Checking all usage strings for status.
   * @return
   */
